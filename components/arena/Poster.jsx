...
export const Poster = () => {
    ...
    return (
        <div className="w-full h-full bg-[#05010A] relative overflow-hidden flex flex-col items-stretch justify-between select-none">
        ...
        {/* --- MAIN CONTENT --- */}
        <main className="flex-grow flex flex-col items-center justify-center py-6 sm:py-8 md:py-12 px-2 sm:px-4 text-center relative z-10">
        ...
        <footer className="flex-none border-t-2 border-[#936DFF] h-12 sm:h-14 md:h-16 flex items-stretch z-20 bg-[#05010A]">
            ...
            <div className="whitespace-nowrap animate-marquee font-display text-[10px] sm:text-xs md:text-sm tracking-[0.2em] text-[#B8B8CC]">
                <span className="mx-4">ZK PROOFS VERIFIED</span>
                <span className="mx-4 text-[#936DFF]">///</span>
                <span className="mx-4">ON-CHAIN SETTLEMENT</span>
                <span className="mx-4 text-[#936DFF]">///</span>
                <span className="mx-4">SHADOW PAY ENABLED</span>
                <span className="mx-4 text-[#936DFF]">///</span>
                <span className="mx-4">UMBRA PROTOCOL V1.0</span>
            </div>
            {/* Gradient masks for ticker */}
            <div className="absolute left-0 top-0 bottom-0 w-8 bg-gradient-to-r from-[#05010A] to-transparent"></div>
            <div className="absolute right-0 top-0 bottom-0 w-8 bg-gradient-to-l from-[#05010A] to-transparent"></div>
            </div>
