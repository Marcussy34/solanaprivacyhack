...
| Layer | Technology |
|-------|------------|
| ZK Circuits | [Noir](https://noir-lang.org/) v1.0.0-beta.18 |
| Blockchain | [Solana](https://solana.com/) |
| Smart Contracts | [Anchor](https://www.anchor-lang.com/) |
| ZK Proving System | [Sunspot](https://github.com/reilabs/sunspot) (Noir → Groth16) |
| ZK Verification | On-chain Groth16 verifier (generated by Sunspot) |
